    ...
    public static void main(String... args) throws IOException, GeneralSecurityException {
        ...
        Calendar service =
                new Calendar.Builder(HTTP_TRANSPORT, JSON_FACTORY, getCredentials(HTTP_TRANSPORT))
                        ...
                        .build();
        service.events().insert("primary",makeEvent("test event 1", "3900 jog rd", "test event description")).execute();
...
//        }
    ...
    public static Event makeEvent(String summary, String eventLocation, String eventDescription){
        ...
        DateTime endDateTime = new DateTime("2022-11-03T17:00:00-07:00");
